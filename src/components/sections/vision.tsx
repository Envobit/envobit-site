    ...
    <section id="vision" className="py-20 bg-supporting-gray">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            We're building the <span className="text-light-blue">future</span>{" "}
            of
            <br />
            product development
          </motion.h2>
          ...
          <div className="text-xl text-gray-600 leading-relaxed space-y-6 mb-12">
            ...
            >
              Imagine a world where every great idea gets both brilliant
              execution and beautiful growth. Where technical excellence and
              market success aren't separate battles. Where the best products
              win because they're built right AND launched right.
            </motion.p>
