    ...
    <section id="methodology" className="py-20 bg-navy text-white">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div
          ...
          data-testid="methodology-header"
        >
          <motion.h2
          ...
          >
            Our proprietary methodology combines development, neuroscience, and
            growth marketing from day one. No handoffs. No misalignment. No
            products that work perfectly but nobody wants.
          </motion.p>
        </div>
